...
(add-test! '(let ((x 2)) (let ((f (lambda (y) (let ((oldx x)) (let ((_ (set! x y))) oldx))))) (f 1))) 2)
...
(add-test! '(letrec ((fac (lambda (n) (let ((t (= n 0))) (if t 1 (let ((u (- n 1))) (let ((v (fac u))) (* n v)))))))) (fac 3)) 6)
(add-test! '(letrec ((x (begin (set! x 123) 456))) x) 456)
(add-test! '(let ((x 123)) (let ((f (lambda (y) y))) (f (set! x 456)) x)) 456)
(add-test! '(let ((x 123)) (let ((f (lambda (x) x))) (f (set! x 456)) x)) 456)
(add-test! '(let ((x 123)) (let ((f (lambda (x y) x))) (f (set! x 456) 789) x)) 456)
(add-test! '(let ((x 123)) (if (set! x 456) 789 0) x) 456)
(add-test! '(let ((x 123)) (if (set! x 456) (set! x 789) (set! x 0)) x) 789)
(add-test! '(let ((x 123)) (let ((y (set! x 456))) x)) 456)
(add-test! '(let ((x 123)) (let ((y (set! x 456))) (set! x 789) x)) 789)
(add-test! '(let ((x 123)) (let ((y (set! x 456))) (let ((z (set! x 789))) 0) x)) 789)
(add-test! '(let ((x 123)) (let ((y (set! x 456))) (set! x 0) (let ((z (set! x 789))) 0) x)) 789)
(add-test! '(let ((x 123)) (let ((y (set! x (set! x 456)))) x)) 'undefined)
(add-test! '(let ((x 123)) (let ((y (set! x (begin (set! x 456) 789)))) x)) 789)
